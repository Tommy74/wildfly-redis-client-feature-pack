...
public enum DistributableWebSubsystemSchema implements SubsystemResourceXMLSchema<DistributableWebSubsystemSchema> {
    ...
    VERSION_6_0_COMMUNITY(6, 0, Stability.COMMUNITY),
    ;
    static final Set<DistributableWebSubsystemSchema> CURRENT = Set.of(VERSION_5_0, VERSION_5_0_COMMUNITY, VERSION_6_0_COMMUNITY);
    ...
    public SubsystemResourceRegistrationXMLElement getSubsystemXMLElement() {
        ResourceXMLChoice.Builder sessionManagementChoiceBuilder = this.factory.choice()
        ...
        if (this.since(VERSION_6_0_COMMUNITY)) {
            sessionManagementChoiceBuilder.addElement(this.redisSessionManagementElement());
        }
        ResourceXMLChoice sessionManagementChoice = sessionManagementChoiceBuilder.build();

        ResourceXMLChoice.Builder userManagementChoiceBuilder = this.factory.choice()
                .withCardinality(XMLCardinality.Unbounded.REQUIRED)
        ...
        if (this.since(VERSION_6_0_COMMUNITY)) {
            userManagementChoiceBuilder.addElement(this.redisUserManagementElement());
        }
        ResourceXMLChoice userManagementChoice = userManagementChoiceBuilder.build();
    ...
    ResourceRegistrationXMLElement redisSessionManagementElement() {
        return this.factory.namedElement(SessionManagementResourceRegistration.REDIS)
                .addAttribute(RedisSessionManagementResourceDefinitionRegistrar.REDIS_CONNECTION)
                .addAttribute(SessionManagementResourceDefinitionRegistrar.GRANULARITY)
                .addAttribute(SessionManagementResourceDefinitionRegistrar.MARSHALLER)
                .withContent(this.affinityChoiceBuilder().build())
                .build();
    }

    NamedResourceRegistrationXMLElement redisUserManagementElement() {
        return this.factory.namedElement(UserManagementResourceRegistration.REDIS)
                .addAttribute(RedisUserManagementResourceDefinitionRegistrar.REDIS_CONNECTION)
                .build();
    }
